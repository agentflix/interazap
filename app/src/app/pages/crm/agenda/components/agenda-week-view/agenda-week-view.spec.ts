...
import { AgendaWeekViewComponent } from './agenda-week-view';
...
describe('AgendaWeekViewComponent', () => {
  let component: AgendaWeekViewComponent;
  let fixture: ComponentFixture<AgendaWeekViewComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [AgendaWeekViewComponent],
    })
      .overrideComponent(AgendaWeekViewComponent, {
        remove: {
    ...
    fixture = TestBed.createComponent(AgendaWeekViewComponent);
  ...
  it('deve definir initialView como timeGridWeek', () => {
    expect(component.weekOptions().initialView).toBe('timeGridWeek');
  });
