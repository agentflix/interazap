    ...
    public function run(): void
    {
        ...
        foreach ($plans as $plan) {
            $content = match ($plan->slug) {
                ...
                'business', 'master', 'enterprise' => 'REGRAS DO PLANO BUSINESS/MASTER/ENTERPRISE: forneça respostas elaboradas e de alto valor, sem limite rígido de palavras quando necessário. Inclua contexto, alternativas com prós e contras, exemplos, tabelas comparativas quando útil e abordagem proativa. Antecipe dúvidas correlatas e proponha próximos passos concretos.',
