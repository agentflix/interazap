# PRD-BILLING-001 — Modulo de Billing InteraZap
...
O InteraZap opera com receita recorrente mensal (MRR - Monthly Recurring Revenue). Cada tenant e cobrado mensalmente com base no plano ativo. O fluxo financeiro e:
    ...
    "data": {
        ...
        "affected_resources": {
            ...
            "instances": {
                ...
                "current": 3,
                "new_limit": 2,
                "affected": [{ "id": "uuid", "name": "Instancia Antiga", "created_at": "2026-01-10" }]
            },
            "storage": { "is_over_limit": false },
            "negotiations": { "impact": "none" }
        }
...
Transforma o array de dados montado em `BillingSubscriptionController` em JSON padrao InteraZap com `success/data`.
