# PREVC Workflow — AgentFlix

> Workflow oficial de desenvolvimento do AgentFlix. Todas as mudanças — features, bugfixes, refactoring, documentação — seguem este processo.
